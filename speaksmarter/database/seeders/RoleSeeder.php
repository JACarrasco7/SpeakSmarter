...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permission_create_lecategory = Permission::create(['name' => 'create categories']);
        $permission_read_category = Permission::create(['name' => 'read categories']);
        $permission_update_lecategory = Permission::create(['name' => 'update categories']);
        $permission_delete_lecategory = Permission::create(['name' => 'delete categories']);
        ...
        $permissions_administrator = [
            ...
            $permission_create_lecategory,
            $permission_read_category,
            $permission_update_lecategory,
            $permission_delete_lecategory
        ];
